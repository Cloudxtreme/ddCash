...
This means one can have an always-on ddCashd instance running, and another local ddCashd/ddCash-qt instance which connects to this node and receives blocks from it.
