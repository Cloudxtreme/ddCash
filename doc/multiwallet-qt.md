...
In order to support loading of multiple wallets in ddcash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ddcash.cpp.
...
Changes to ddcash.cpp
----------------------
ddcash.cpp is the entry point into ddcash-qt, and as such, will require some minor modifications to provide hooks for
