                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received ddCash from zddCash"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zddCash"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zddCash));
