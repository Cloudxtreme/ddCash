...
/** Utility functions used by the ddCash Qt UI.
 */
namespace GUIUtil
{
...
// Render ddCash addresses in monospace font
...
// Parse "ddcash:" URI into recipient object, return true on successful parsing
