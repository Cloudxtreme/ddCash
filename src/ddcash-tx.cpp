...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ddCash Core ddcash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ddcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ddcash transaction") + "\n" +
                               "  ddcash-tx [options] -create [commands]   " + _("Create hex-encoded ddcash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ddcash transaction
